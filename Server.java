...
public class Server extends Thread {
        ...
        while ((!objNetwork.getClientConnectionStatus().equals("disconnected"))) {
            ...
            if (!objNetwork.getInBufferStatus().equals("empty")) {
                ...
                if (trans.getOperationType().equals("QUERY")) {
                    ...
                    // System.out.println("\n DEBUG : Server.processTransactions() - Obtaining
                    // balance from account" + trans.getAccountNumber());
                }
                ...
                // System.out.println("\n DEBUG : Server.processTransactions() - transferring
                // out account " + trans.getAccountNumber());
    ...
    public void run() {
        ...
        // Calculating the total processing time for the transactions. in Milli seconds.
        serverStartTime = System.currentTimeMillis();
        processTransactions(trans);
        serverEndTime = System.currentTimeMillis();

        // Disconnecting server From the network
